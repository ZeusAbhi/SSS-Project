...
export const marvelImages =(arr,x,y)=>{
...
export const Marvel = () => {
  ...
  return (
    ...
    <div className='marvelbox'>
       <div className="route_heading" style={{display:"flex" ,gap:"5vw"}}>
      <div className="marvelheading"><b style={{paddingLeft:"0.5vw"}}>MARVEL MOVIES</b></div>
        
      <Link id="viewroute" to="/view" style={{textDecoration:"none",color:"black"}}>
            View All
        </Link>
        </div>
